...
This monorepo is setup for a dummy `@skillrecordings/` NPM organization. There are 2 packages by default:

- `@skillrecordings/react` - A placholder React component
- `@skillrecordings/utils` - A utils packages

Unlike other TSDX templates, the developer experience for this template is currently a bit more manual.

Your first order of business will be to search and replace `@skillrecordings` for the npm organization of your own.
